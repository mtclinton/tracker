...
function Pagination(props) {
  ...
  if (pages < 7){
      return (
          <nav className="pagination is-rounded is-centered" role="navigation" aria-label="pagination">
              <a className="pagination-previous" {(page===1) ? disabled :''}>Previous</a>
              <a className="pagination-next" {(page===pages) ? "is-current" :''}>Next</a>
  ...
  if(page < 5){
      return (
          <nav className="pagination is-rounded is-centered" role="navigation" aria-label="pagination">
              <a className="pagination-previous" {(page===1) ? disabled :''}>Previous</a>
              <a className="pagination-next" {(page===pages) ? disabled :''}>Next</a>
              <ul className="pagination-list">
