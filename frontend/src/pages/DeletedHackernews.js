...
const fetchStories = async (page)  => {
    try {
        let request = `${BASE_API_URL}/hn/deleted/${page}`;
...
const fetchPages = async ()  => {
    try {
        let request = `${BASE_API_URL}/hn/deletedpages`;
...
function DeletedHackernews(props) {
    const { match } = props;
                ...
                <div class="columns">
                    ...
                    <div className="column is-9">
                        ...
                        <div style={{margin:"50px 0px"}}>
                            <Pagination page={getPageNumber(match.params.page)} pages={pages} type={'/deleted'}/>
                        </div>
                    </div>
                </div>
            </div>
...
export default DeletedHackernews;