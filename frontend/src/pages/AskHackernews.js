...
const fetchStories = async (page)  => {
    try {
        let request = `${BASE_API_URL}/hn/ask/${page}`;
...
const fetchPages = async ()  => {
    try {
        let request = `${BASE_API_URL}/hn/pages/ask_rank`;
                ...
                <div class="columns">
                    ...
                    <div className="column is-9">
                        ...
                        <div style={{margin:"50px 0px"}}>
                            <Pagination page={getPageNumber(match.params.page)} pages={pages} type={'/ask'}/>
                        </div>
                    </div>
                </div>
            </div>
