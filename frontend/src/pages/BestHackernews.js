...
const fetchStories = async (page)  => {
    try {
        let request = `${BASE_API_URL}/hn/best/${page}`;
...
const fetchPages = async ()  => {
    try {
        let request = `${BASE_API_URL}/hn/pages/best_rank`;
                ...
                <div class="columns">
                    ...
                    <div className="column is-9">
                        ...
                        <div style={{margin:"50px 0px"}}>
                            <Pagination page={getPageNumber(match.params.page)} pages={pages} type={'/best'}/>
                        </div>
                    </div>
                </div>
            </div>
